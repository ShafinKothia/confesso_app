    ...
    return (
        <View style={{ height: '100%', width: '100%', alignItems: 'center', justifyContent: 'center', backgroundColor: '#121212' }}>
            <View style={{ height: '80%', width: '100%', alignItems: 'center', justifyContent: 'center', }}>
                ...
                <MaterialCommunityIcons color='#663399' size={200} name='shield-check-outline' />

                <Text style={{ color: 'white', textAlign: 'center', fontSize: 35, fontWeight: '400', }}> Protection</Text>
                <Text style={{ color: 'white', textAlign: 'center', fontSize: 35, fontWeight: '200', marginTop: 10 }}> Nobody can shut this app down</Text>
            ...
            <View style={{ flexDirection: 'row', marginTop: 100 }}>
                ...
                <View style={{width: '20%', paddingRight: 20, alignItems: 'flex-end', justifyContent: 'center'}}>
                    <SimpleLineIcons color='white' size={35} name='arrow-right' onPress={() => { navigation.replace('Login') }}></SimpleLineIcons>
                </View>
            </View>
        </View>
    )
